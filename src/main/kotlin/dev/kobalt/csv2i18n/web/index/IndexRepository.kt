...
package dev.kobalt.csv2i18n.web.index

import dev.kobalt.csv2i18n.web.about.AboutRepository
import dev.kobalt.csv2i18n.web.convert.ConvertRepository
import dev.kobalt.csv2i18n.web.download.DownloadRepository
import dev.kobalt.csv2i18n.web.legal.LegalRepository
import dev.kobalt.csv2i18n.web.source.SourceRepository

object IndexRepository {

    val pageTitle = "Index"
    val pageSubtitle = "Convert your CSV file with strings to Android XML or iOS strings localization file."
