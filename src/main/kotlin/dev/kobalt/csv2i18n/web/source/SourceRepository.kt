...
package dev.kobalt.csv2i18n.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.csv2i18n.jvm", "Application", "Executable JAR that is used to convert stuff."),
        Triple("dev.kobalt.csv2i18n.web", "Frontend", "Website server that uses executable JAR for conversion.")
    )
